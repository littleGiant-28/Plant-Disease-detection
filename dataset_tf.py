...
class dataset:
    def __init__(self,folder_name,repeat=1,shuffle_buffer_size=3000,batch_size=10,n_parse_threads=2):
        self.folder_name=folder_name
        self.repeat=repeat
        self.shuffle_buffer_size=shuffle_buffer_size
        self.batch_size=batch_size
        self.n_parse_threads=n_parse_threads
        self.DATASET_PATH="C:/Users/Dell/PlantVillage-Dataset/raw/color/"
